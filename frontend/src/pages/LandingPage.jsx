		...
		<div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-white via-purple-50 to-white text-slate-900">
			...
			<main className="relative z-10 pt-32 pb-20">
				<section id="platform" className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 text-center">
					...
					<div className="max-w-xl rounded-2xl border border-rose-200 bg-rose-50/70 p-4 text-center shadow-sm backdrop-blur">
						...
						<a
							...
							className="mt-2 inline-flex items-center gap-1 text-sm font-bold text-rose-900 hover:text-rose-950 underline decoration-2 decoration-rose-900/40"
						>
							Watch the FlowSync Demo Video on YouTube
						</a>
					</div>
