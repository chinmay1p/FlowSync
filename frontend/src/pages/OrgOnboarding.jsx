		...
		<div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-white px-6 py-16">
			<div className="mx-auto max-w-4xl space-y-8">
				<header className="text-center space-y-3">
					...
					<h1 className="text-4xl font-semibold text-slate-900">Bring FlowSync to your organization</h1>
				...
				<div className="grid gap-6 md:grid-cols-2">
					<div className="rounded-3xl border border-purple-100 bg-white p-6 shadow-xl">
						<p className="text-xs uppercase tracking-[0.4em] text-purple-400">New to FlowSync</p>
