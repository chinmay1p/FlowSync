	...
	return (
		<div className="space-y-6">
			<header>
				...
				<p className="text-sm text-slate-600">Workspace identity and access controls.</p>
			</header>
			...
			<div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl space-y-4">
				<div>
					...
					<p className="text-xl font-semibold text-slate-900">{context.organization?.name}</p>
				</div>
				<div>
					<p className="text-xs uppercase tracking-wide text-slate-500">Description</p>
					<p className="text-sm text-slate-600">{context.organization?.description || 'No description set.'}</p>
				</div>
				<div className="flex items-center justify-between rounded-2xl border border-slate-100 px-4 py-3">
					<div>
						...
						<p className="text-lg font-semibold text-slate-900">{context.organization?.joinCode}</p>
					</div>
					<button onClick={handleCopy} className="rounded-full border border-slate-300 px-4 py-2 text-xs font-semibold text-slate-700">
						Copy
					</button>
				</div>
			...
			<div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl space-y-4">
				<div>
					<p className="text-xs uppercase tracking-wide text-slate-500">Connect Chrome Extension</p>
					<p className="text-sm text-slate-600">Generate an admin session token for the extension.</p>
				</div>
				<button
				...
				{sessionInfo && (
					<div className="space-y-2">
						<label className="text-xs uppercase tracking-wide text-slate-500">Session ID</label>
...
const Restricted = () => (
	<div className="rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-xl">
		<p className="text-sm text-slate-600">Only organization admins can access these settings.</p>
	</div>
)
