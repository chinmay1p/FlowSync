	...
	return (
		<div className="space-y-6">
			<header>
				...
				<p className="text-sm text-slate-600">Manage your account basics.</p>
			</header>
			...
			<div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl space-y-4">
				<div>
					<p className="text-sm font-semibold text-slate-900">Connect Chrome Extension</p>
					<p className="text-xs text-slate-500">Generate a one-time code for the Meeting Intelligence extension.</p>
				</div>
				<button
			...
			<div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
				...
				<button onClick={logout} className="mt-4 rounded-2xl border border-rose-200 px-4 py-2 text-sm font-semibold text-rose-600">
					Logout
				</button>
			</div>
		</div>
